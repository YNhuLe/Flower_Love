...
const styleMap: Record<string, string> = {
  ...
  add: " text-sm bg-primary border border-tertiary hover:bg-third hover:border-primary hover:text-primary  transition-all duration-300 text-tertiary",
  ...
  customize : "text-xs bg-cartRed hover:bg-darkCartRed transition-all duration-300 ",
  shop_now: "text-xs bg-accent hover:bg-primary transition-all duration-300  absolute bottom-[1rem] left-[1rem]"
