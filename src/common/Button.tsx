...
const styleMap: Record<string, string> = {
  ...
  add: " text-sm bg-primary border border-tertiary hover:bg-third hover:border-primary hover:text-primary text-tertiary",
  cancel: " text-sm bg-purple-500 hover:bg-blue-500 text-tertiary",
  submit: " text-sm bg-pink-500 hover:bg-blue-500 text-tertiary",
  explore: "  text-sm border border-cartRed hover:bg-cartRed hover:text-third text-cartRed mt-5 mb-8",
  ...
  customize : "text-xs bg-cartRed hover:bg-darkCartRed",
  shop_now: "text-xs bg-accent hover:bg-primary"
