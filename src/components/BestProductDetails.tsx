...
function BestProductDetails({ products }: { products: BestProductProp }) {
  ...
  return (
    <div
      className="max-w-fit h-50 mt-8 mb-8 p-4 border ml-2 mr-2 border-green-900 rounded-lg shadow-lg
    "
    >
      <img
        className="h-32 w-28 m-auto"
      ...
      <div className="flex flex-row justify-center gap-2">
        ...
        <p className="text-center text-xs line-through ">
