...
import { Box, ChevronLeft, Search } from "lucide-react";
...
/**
 * 
 * @returns A JSX element representing the checkout page,
 *  which includes the shipping information form, billing address, 
 * payment methods, order summary, and a button to place the order.
 * 
 */
        ...
        <>
            ...
            <div className="bg-surface-base">
                <section className="">
                    ...
                    <div className="rounded-md bg-surface-card p-4 shadow-md w-auto m-4 ">
