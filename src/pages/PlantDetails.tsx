    ...
    return (plantInfo &&
        <section className="mx-4">
            <div>
                ...
                <img className="bg-grey bg-opacity-70 rounded-xl" src={`${cloud_url}/${plantInfo.image_url}`} alt={plantInfo.common_name} />
                <div className="flex flex-row aligns-between gap-1 mt-2">
