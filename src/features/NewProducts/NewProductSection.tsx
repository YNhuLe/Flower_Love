...
import { PlantWithSize, ProductWithCategory } from "../../types/types";
...
function NewProductSection() {
    ...
    const [newProducts, setNewProducts] = useState<PlantWithSize[]>([]);
    ...
    useEffect(() => {
        const fetchNewProducts = async () => {
            try {
                const response = await axios.get(`${baesUrl}/allplants`);
