 ...
 * If rendered in the checkout page, it also displays the items in the cart with their details.
 * @returns A JSX element representing the order summary component
 * contains the subtotal, discount, shipping fee, tax, and total amount for the order.
 */
function OrderSummary({ isCheckout }: { isCheckout: boolean }) {
